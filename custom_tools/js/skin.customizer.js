...
#booking_slot_form > div > a:hover,\
	...
	.top_panel_style_light .content .search_wrap.search_style_regular .search_icon:hover\
			...
			.post_content.ih-item.circle.effect1 .spinner, .saltify-menu li > h3:after, .sc_chat:after,	.comments_list_wrap .comment-respond\
			{\
			...
			.eg-saltify-skin-container,	.sc_slider_swiper .sc_slider_info\
			{\
		...
		custom_style += '\
			user_color,			.sc_icon_shape_round.sc_icon_bg_user:hover,	.sc_icon_shape_square.sc_icon_bg_user:hover,			a:hover .sc_icon_shape_round.sc_icon_bg_user,			a:hover .sc_icon_shape_square.sc_icon_bg_user,	.sc_icon_bg_user,	.post_item:nth-child(3n+3) .post_rating .reviews_stars_bg,	.post_item:nth-child(3n+3) .post_rating .reviews_stars_hover,	.post_item:nth-child(3n+3) .post_rating .reviews_value,	.saltify-menu li > p + p,	.bg_tint_light .sc_contact_form .sc_contact_form_field input,	.bg_tint_light .sc_contact_form .sc_contact_form_message textarea,	.reviews_block .reviews_item:nth-child(3n+3) .reviews_stars_hover,			textarea,	.bg_tint_light input[type="text"],	.bg_tint_light input[type="number"],	.bg_tint_light input[type="email"],	.bg_tint_light input[type="search"],	.bg_tint_light input[type="password"],	.bg_tint_light textarea,	.sc_emailer input[type="text"],	.pagination_wrap .pager_next:hover, .widget_area .widget_product_tag_cloud a, .widget_area .widget_tag_cloud a, .sc_testimonial_content\
			{\
				color: '+clr+';\
			}\
